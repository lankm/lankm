The purpose of this is to provide compile time type checking of physical units. This reduces runtime bugs by making sure the units of different calculations always match at compile time.
